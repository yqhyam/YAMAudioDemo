...
internal class Recorder {
    ...
    internal var onPowerData: ((Float32) -> Void)?                   // callback for peak volume power
    ...
    private func prepareToRecord() {
        ...
        let numBuffers = 5
        let bufferSize = deriveBufferSize(seconds: 0.03)
    ...
    private func samplePower() {
        ...
        let meteringProperty = kAudioQueueProperty_CurrentLevelMeter
